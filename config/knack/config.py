cfg = {
    ...
    'locations' : {
        'primary_key' : 'ATD_LOCATION_ID',  
        'obj' : None,
        'ref_obj' : ['object_11'],
        'scene' : 'scene_425',
        'view' : 'view_1201',
        'service_url' : 'http://services.arcgis.com/0L95CJ0VTaxqcmED/ArcGIS/rest/services/locations_atd/FeatureServer/0/',
        'include_ids' : True,
        'socrata_resource_id' : 'r9mz-ucua',
        'pub_log_id' : 'n5kp-f8k4',
        'ip_field' : None,
        'location_fields' : {
            'lat' : 'LOCATION_latitude',
