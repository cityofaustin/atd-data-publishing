SCRIPTDIR = {
    ...
    "open_data": ["knack_data_pub", "pgrest_data_pub", "radar_count_pub",
                  "sig_stat_pub", "cifs"],

    "traffic_study": ["table_config", "traffic_study_cls",
                      "traffic_study_loader", "traffic_study_locations",
                      "traffic_study_spd", "traffic_study_vol"],
