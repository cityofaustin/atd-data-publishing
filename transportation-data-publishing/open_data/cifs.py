...
def main():
    ...
    try:
        ...
        upload_response = socratautil.replace_non_data_file(socrata_creds, socrata_resource_id_json, 'traffic-incidents.json', file_string)
        ...
        upsert_response = socratautil.upsert_data(socrata_creds, tabular_data, socrata_resource_id_csv)
